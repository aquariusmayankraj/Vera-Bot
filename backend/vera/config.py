...
class Settings:
    ...
    # Public, synthetic-data demo by default. Set an exact Netlify origin later.
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            cors_origins=tuple(x.strip().rstrip("/") for x in os.getenv("CORS_ORIGINS", "*").split(",") if x.strip()),
            frontend_url=os.getenv("FRONTEND_URL", "").strip(),
            demo_enabled=os.getenv("DEMO_ENABLED", "true").lower() == "true",
            demo_db_path=os.getenv("DEMO_DB_PATH", ""),
